 ...
 const reducer = (state, action) => {
        switch (action.type) {
          ...
          case "INCREMENT":
            return {
              ...state,
              [action.payload.name]: state.quantity + action.payload.count,
            };
          case "DECREMENT":
            return {
              ...state,
  ...
  return (
    <div className='h-screen w-screen flex justify-center mt-8 items-center overflow-auto'>
      <form
      ...
      >
        <div className='flex flex-col w-full max-w-xs'>
          ...
          <input
            ...
            name='firstName'
            id='firstName'
            className='border-solid border-2 rounded border-cyan-600 '
            onBlur={(e) =>
              dispatch({
                type: "INPUT",
        ...
        <div className='flex flex-col w-full max-w-xs'>
          ...
          <div className='flex justify-between items-center gap-2 '>
            <button
             ...
             onClick={(e) => dispatch({ type: "DECREMENT", payload: {name: e.target.name, count: 1 } })}>
              -
            </button>
            ...
            <button className='bg-indigo-500 text-lg text-white rounded h-10 w-10'
                   onClick={(e) => dispatch({ type: "INCREMENT", payload: {name: e.target.name, count: 1 } })}>
              +
            </button>
          </div>
        </div>
